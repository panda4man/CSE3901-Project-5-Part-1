            ...
            init: function(b) {
                ...
                b = a.extend(c, b), a(this).each(function() {
                    ...
                    a(".drag-target").hammer({
                        ...
                        if (e.hasClass("active")) g = !1, f = !1, c();
                        else {
                            "left" === b.edge ? (a(".drag-target").css({
                                width: "50%",
                                right: 0,
    ...
    function(a) {
        a.fn.slider = function(b) {
            ...
            return b = a.extend(c, b), this.each(function() {
                ...
                function d(a) {
                    console.log("Move to slide"), a >= h.length ? a = 0 : 0 > a && (a = h.length - 1), i = g.find(".active").index(), i != a && (e = h.eq(i), $caption = e.find(".caption"), e.removeClass("active"), e.velocity({
                        opacity: 0
                    }, {
